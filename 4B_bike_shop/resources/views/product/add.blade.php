...
<form action="/product" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="product" class="form-control" id="exampleFormControlInput1" placeholder="product">
    </div>
    <div class="form-group">
        ...
        <select class="form-control" id="exampleFormControlSelect1" name="importir">
            ...
            <option value="{{$importir->id}}">{{$importir->name}}</option>
            @endforeach
        </select>
    </div>
    <div class="form-group">
        <label for="exampleFormControlInput1">Qty</label>
        <input type="number" name="qty" class="form-control" id="exampleFormControlInput1" placeholder="qty">
    </div>
    <div class="form-group">
